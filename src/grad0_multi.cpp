...
// [[Rcpp::export]]
arma::vec grad0cpp_multi(arma::vec w, arma::vec beta, arma::vec mu,
                         ...
                         arma::mat Sr, arma::mat Se, arma::mat SSr) {
  ...
  arma::mat Deno_P = Mu_multi * trans(SSr);
  arma::mat P = Mu_multi / Deno_P;
  arma::mat grad_loss_multi_mat =  -(1.0/n_obs) * trans(X) * (Y - P);

  arma::mat grad_loss_mat = (grad_loss_multi_mat % white_coefs);
